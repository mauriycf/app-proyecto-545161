...
<div class="portfolio-resume hero-portafolio">
  ...
  <div class="large-4 columns">
    <div class="portfolio-resume-wrapper">
      <img class="portfolio-resume-headshot" src="{{asset('images/support.png')}}" width="40%" alt="headshot">
      <h3 class="portfolio-resume-header">Soporte Técnico En: </h3>
      <ul>
        <li>Hardware y Software</li>
        <li>Sistemas Operativos</li>
        <li>24 horas del dia</li>
        <li>soporte tecnico garantizado</li>
      </ul>
    </div>
  </div>
